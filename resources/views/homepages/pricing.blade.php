        ...
        <div class="space-y-6">
            <div class="space-y-3">
                <div class="!text-center lg:!text-start">
                    <p class="text-xs font-semibold text-gray-700 dark:hidden">PRICING</p>
                    <p class="hidden text-xs font-semibold text-gray-300 dark:block">PRICING</p>
                </div>

                <flux:heading
                    class="!text-4xl md:!text-5xl font-thin max-w-4xl mx-auto lg:mx-0 lg:max-w-full text-center lg:text-start">
                    You are gonna love this! Get ready for<br class="hidden lg:block"> remarkable<span
                        class="font-black text-teal-600 dark:text-teal-400"> online presence</span></flux:heading>
                <flux:subheading
            ...
            <!-- Pricing -->
            <div class="flex flex-col w-full max-w-md gap-6 py-6 lg:flex-row lg:max-w-none lg:gap-0">
                <!-- Growth Plan -->
                <div
                    ...
                    <flux:card
                        class="flex flex-col h-full p-6 bg-white rounded-lg shadow-sm md:p-8 dark:bg-zinc-800 lg:rounded-r-none">
                        <div class="space-y-6">
                            <div class="space-y-2">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div class="flex items-center gap-2">
                                    <flux:icon.check-circle class="text-teal-600 dark:text-teal-400" variant="solid" />
                            ...
                            <flux:button class="w-full" variant="filled" icon-trailing="chevron-right">Purchase</flux:button>
                        </div>
                    </flux:card>
                </div>

                <div
                    class="flex flex-col flex-1 gap-2 p-2 border-2 border-teal-800 rounded-2xl dark:border-teal-200 bg-zinc-100 dark:bg-zinc-900 lg:-mb-4">

                    <!-- Premium Plan -->
                    <flux:card
                        class="flex flex-col h-full p-6 bg-white rounded-lg shadow-sm md:p-8 dark:bg-zinc-800 lg:pb-12">
                        <div class="space-y-6">
                            <div class="space-y-2">
                                <flux:badge icon="fire" size="sm" color="teal" class="mb-1">Popular package</flux:badge>
                            ...
                            <flux:button class="w-full" variant="primary" icon-trailing="chevron-right">Purchase</flux:button>
                        </div>
                    </flux:card>
                </div>
                ...
                <div
                    ...
                    <!-- Elite Plan -->
                    <flux:card
                        class="flex flex-col h-full p-6 bg-white rounded-lg shadow-sm md:p-8 dark:bg-zinc-800 lg:rounded-l-none">
                        <div class="space-y-6">
                            <div class="space-y-2">
            ...
            <p class="text-sm text-center">Looking for a more customized plan? <a wire:navigate href="contact" class="font-semibold text-teal-600 dark:text-teal-400">Contact us</a></p>
        </div>
    </flux:main>
</x-app-layout>
