<x-app-layout>
    <flux:main container>
        <div class="space-y-6">
            <div class="space-y-6">
                <flux:heading class="!text-2xl lg:!text-4xl">Privacy Policy</flux:heading>
                <p class="text-sm">Effective date: <span class="bold">February 02, 2025</span></p>
            </div>

            <div>
                <flux:heading size="lg">1. Data collection</flux:heading>
                <flux:subheading>
            ...
            <div>
                <flux:heading size="lg">2. Responsible entity</flux:heading>
                <flux:subheading>
            ...
            <div>
                <flux:heading size="lg">3. Data usage</flux:heading>
                <flux:subheading>
            ...
            <div>
                <flux:heading size="lg">4. Data sharing</flux:heading>
                <flux:subheading>
            ...
            <div>
                <flux:heading size="lg">5. Data security</flux:heading>
                <flux:subheading>
            ...
            <div>
                <flux:heading size="lg">6. User rights</flux:heading>
                <flux:subheading>
            ...
            <div>
                <flux:heading size="lg">7. Policy updates</flux:heading>
                <flux:subheading>
            ...
            <div>
                <flux:heading size="lg">8. Contact information</flux:heading>
                <flux:subheading>
