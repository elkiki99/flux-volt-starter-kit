            ...
            <div class="w-full space-y-3 lg:w-1/2">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center justify-center gap-4 lg:justify-start">
                        ...
                        <flux:link wire:navigate href="/pricing">Our pricing page</flux:link>
                    </div>
                </div>
            </div>

            <flux:card class="z-10 justify-center w-full max-w-xl mx-auto space-y-6 lg:mx-0 !p-10 !bg-transparent">
