        ...
        <section class="min-h-[85vh] flex flex-col space-y-6">
            ...
            <div class="mt-auto space-y-3">
                <div class="!text-center lg:!text-start">
                    <flux:badge icon="rocket-launch" color="yellow" size="sm" variant="pill">Pro collaborator
                    </flux:badge>
                </div>
                ...
                <flux:heading
                    ...
                    We build websites that <br class="hidden lg:block">drive bussiness <span
                        class="!text-5xl font-black text-transparent md:!text-7xl dark:from-yellow-500 dark:via-yellow-200 dark:to-yellow-600 bg-gradient-to-r from-yellow-600 via-yellow-300 to-yellow-500 bg-clip-text">success</span>
                </flux:heading>
                <flux:subheading
            ...
            <div class="flex flex-col py-6 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                    <flux:card
                        ...
                        <div class="space-y-3">
                            <flux:subheading>Samsung: A multibillion dollar company focused on smartphones innovation.
                            </flux:subheading>
                    ...
                    <flux:card
                        ...
                        <div class="space-y-3">
                            <flux:subheading>Nike: Famous sports clothing brand that reshapes the industry.
                            </flux:subheading>
                            <div class="flex items-end space-x-2">
                    ...
                    <flux:card
                        ...
                        <div class="space-y-3">
                            <flux:subheading>Coca Cola Company: A global leader in the beverage industry.
                            </flux:subheading>
                            <div class="flex items-end space-x-2">
                    ...
                    <flux:card
                        ...
                        <div class="space-y-3">
                            <flux:subheading>Gucci: Famous luxury brand known for its handbags and shoes.
                            </flux:subheading>
                            <div class="flex items-end space-x-2">
