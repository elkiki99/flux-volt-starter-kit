    ...
    <flux:main container>
        ...
        <section class="min-h-screen space-y-6">
            ...
            <div x-data x-init="$nextTick(() => {
                ...
                });" class="relative z-10 w-full py-6 bg-transparent container-block">
                <div
                    ...
                    <div
                        class="absolute left-0 z-20 w-40 h-full bg-gradient-to-r dark:from-zinc-900 from-white to-transparent">
                    </div>
                    <div
                        class="absolute right-0 z-20 w-40 h-full bg-gradient-to-l dark:from-zinc-900 from-white to-transparent">
                    </div>
                    <div x-ref="content" class="flex animate-marquee">
                        <div x-ref="item"
                            class="flex items-center justify-around flex-shrink-0 w-full py-2 space-x-2 text-zinc-700 dark:text-white">
                    ...
                    <article class="flex flex-col-reverse justify-center gap-8 lg:flex-row">
                        <div class="flex flex-col w-full space-y-6 lg:w-1/2">
                            ...
                            <flux:button class="!w-auto inline-block text-start" icon-trailing="arrow-up-right"
                                wire:navigate as="link" variant="ghost" href="/services"
                ...
                <flux:card class="lg:flex lg:!pt-10 lg:!pb-10 !pl-10 lg:!pl-0 !pt-0 !pr-10 !bg-transparent">
                    <article class="flex flex-col-reverse justify-center gap-8 lg:flex-row-reverse">
                        <div class="flex flex-col w-full space-y-6 lg:w-1/2">
                            ...
                            <div class="flex flex-col flex-grow gap-2 py-6 space-y-6">
                                <div class="space-y-3">
                                    ...
                                    <flux:subheading class="max-w-2xl ml-[2rem]">We uphold the highest standards of honesty and transparency in all our dealings, fostering trust and accountability.
                                    </flux:subheading>
                                </div>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <flux:subheading class="max-w-2xl ml-[2rem]">We believe that great things are achieved through collaboration, teamwork, and mutual respect. We work together to create innovative solutions.</flux:subheading>
                                </div>
                            </div>

                            <flux:button class="!w-auto inline-block text-start" icon-trailing="arrow-up-right"
                                wire:navigate as="link" variant="ghost" href="/about"
                                class="!w-auto text-start">
                        ...
                        <flux:card
                            ...
                            <img class="object-cover h-full rounded-b-lg lg:rounded-r-lg lg:rounded-br-lg lg:rounded-l-none"
                    ...
                    <article class="flex flex-col-reverse justify-center gap-8 lg:flex-row">
                        <div class="flex flex-col w-full space-y-6 lg:w-1/2">
                            <div class="gap-2">
                                ...
                                <flux:subheading class="max-w-xl">We approach each project with a comprehensive, results-driven mindset. Whether it's enhancing user engagement or streamlining business processes, our solutions are designed to align with your unique objectives, bringing measurable impact and growth.</flux:subheading>
                            </div>
                            ...
                            <div class="flex flex-col flex-grow gap-2 py-6 space-y-6">
                                <div class="space-y-3">
                                    ...
                                    <flux:subheading class="max-w-2xl ml-[2rem]">We focus on addressing complex challenges with creative and tailored digital solutions that push boundaries and deliver lasting value for our clients.
                                    </flux:subheading>
                                </div>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <flux:subheading class="max-w-2xl ml-[2rem]">We build robust, scalable systems that evolve with your business, ensuring long-term success and seamless growth as your needs change.</flux:subheading>
                                </div>
                            </div>

                            <flux:button class="!w-auto inline-block text-start" icon-trailing="arrow-up-right"
                                wire:navigate as="link" variant="ghost" href="/case-studies"
                                class="!w-auto text-start">
        ...
        <section class="min-h-screen py-6 space-y-6 ">
            ...
            <div class="flex flex-col py-6 space-y-6">
                ...
                <div class="flex justify-end">
                    <flux:button icon-trailing="arrow-up-right" as="link" variant="ghost" wire:navigate href="/case-studies">
                        Case studies
                    </flux:button>
                </div>
            </div>
        ...
        <section class="py-6 space-y-6 ">
            ...
            <div class="flex justify-end">
                <flux:button icon-trailing="arrow-up-right" as="link" variant="ghost" wire:navigate href="/pricing">
                    Our packages
                </flux:button>
            </div>
        </section>
        ...
        <section class="min-h-screen py-6 space-y-6">
            ...
            <div class="items-center gap-4 space-y-6 lg:flex lg:space-y-0">
                <flux:card class="relative !p-0 lg:w-1/3 h-[80vh] hover:opacity-80 hover:bg-black transition duration-300 !border-none">
                    <a wire:navigate href="/blog">
                        <img loading="lazy" class="object-cover w-full h-full rounded-lg" src="{{ asset('blog-1.webp') }}">
                        <div
                            class="absolute bottom-0 left-0 w-full h-32 rounded-b-lg bg-gradient-to-t from-black/90 to-transparent">
                        </div>
                        <flux:heading class="absolute !text-2xl bottom-10 left-4 !text-white">Web data & conversion</flux:heading>
                ...
                <flux:card class="relative !p-0 lg:w-1/3 h-[80vh] hover:opacity-80 hover:bg-black transition duration-300 !border-none">
                    <a wire:navigate href="/blog">
                        <img loading="lazy" class="object-cover w-full h-full rounded-lg" src="{{ asset('blog-2.webp') }}">
                        <div
                            class="absolute bottom-0 left-0 w-full h-32 rounded-b-lg bg-gradient-to-t from-black/90 to-transparent">
                        </div>
                ...
                <flux:card class="relative !p-0 lg:w-1/3 h-[80vh] hover:opacity-80 hover:bg-black transition duration-300 !border-none">
                    <a wire:navigate href="/blog">
                        <img loading="lazy" class="object-cover w-full h-full rounded-lg" src="{{ asset('blog-3.webp') }}">
                        <div
                            class="absolute bottom-0 left-0 w-full h-32 rounded-b-lg bg-gradient-to-t from-black/90 to-transparent">
                        </div>
