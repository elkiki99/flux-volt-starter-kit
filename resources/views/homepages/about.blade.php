        ...
        <div class="space-y-6">
            ...
            <div class="space-y-3">
                ...
                <flux:heading
                    ...
                    Turning your creative ideas into<br class="hidden lg:block">dominant <span class="font-black text-teal-600 dark:text-teal-400">digital success</span></flux:heading>
                <flux:subheading
                ...
                <!-- FAQs -->
                <flux:accordion exclusive class="max-w-3xl mt-6">
