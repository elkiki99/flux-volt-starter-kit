<x-app-layout>
    <flux:main container>
        ...
        <section class="min-h-screen py-6 space-y-6">
            <flux:heading class="font-bold py-6 !text-4xl text-center lg:!text-5xl">Since 2023, <br>working on
                delivering
                quality solutions
            </flux:heading>
        ...
        <section class="py-6 space-y-6 ">
            <div class="py-6 text-center">
                <flux:heading class="font-bold !text-4xl lg:!text-5xl">Led by a team of dedicated people
                </flux:heading>
                <flux:subheading>Whose expertice can be relied upon
                </flux:subheading>
            </div>
