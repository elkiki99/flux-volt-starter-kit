            ...
            <div class="z-10 pb-10 my-6 space-y-6">
                <div class="space-y-3">
                    <div class="!text-center lg:!text-start">
                        <flux:badge color="yellow" icon="lock-closed" size="sm" variant="pill" class="mb-3">Security first
                        </flux:badge>
                    </div>
                    ...
                    <flux:heading
                        ...
                        Web development, digital <br class="hidden lg:block">marketing, optimization, <br class="hidden lg:block">we got <span
                            class="!text-5xl font-black text-transparent md:!text-7xl dark:from-yellow-500 dark:via-yellow-200 dark:to-yellow-600 bg-gradient-to-r from-yellow-600 via-yellow-300 to-yellow-500 bg-clip-text">you covered</span></flux:heading>
                    <flux:subheading
