...
new class extends Component {
    ...
    {
        $this->uruguay = Carbon::now('America/Montevideo')->format('H:i');
        $this->argentina = Carbon::now('America/Argentina/Buenos_Aires')->format('H:i');
    }
}; ?>
            ...
            <div class="flex flex-col justify-between gap-8 py-6 mt-0 lg:mt-6 lg:flex-row lg:py-0">
                ...
                <div class="flex justify-between w-full gap-4 mt-6 lg:mt-0 lg:w-1/2 text-start">
                    ...
                    <div wire:poll.10s="updateTime" class="space-y-6">
                        <div>
                            <flux:heading>Uruguay - {{ $uruguay }}</flux:heading>
                            <flux:subheading>Isla de Flores y Salto, 11200</flux:subheading>
                        </div>

                        <div>
                            <flux:heading>Argentina - {{ $argentina }}</flux:heading>
                            <flux:subheading>Av. Rivadavia, 5108</flux:subheading>
                        </div>
                    </div>
                </div>
