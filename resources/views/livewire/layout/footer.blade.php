...
<div class="px-12 py-6 mx-auto space-y-6">
    <div class="flex justify-between">
        ...
        <div class="flex flex-col w-1/2 gap-4 text-start">
            <a wire:navigate href="contact" class="font-semibold text-black dark:text-white">About</a>
            <a wire:navigate href="contact" class="font-semibold text-black dark:text-white">Services</a>
            <a wire:navigate href="contact" class="font-semibold text-black dark:text-white">Pricing</a>
            <a wire:navigate href="contact" class="font-semibold text-black dark:text-white">Contact</a>
            <a wire:navigate href="contact" class="font-semibold text-black dark:text-white">Case studies</a>
        </div>
    </div>
